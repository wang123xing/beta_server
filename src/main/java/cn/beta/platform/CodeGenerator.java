...
public class CodeGenerator {
     ...
     * 配置文件名
     */
    private final static String APP_PROPERTY = "generator.properties";
    private String projectPath = System.getProperty("user.dir");
    /**
     * 公共包路径
     */
    private String parentPackage = "cn.beta";
    /**
     * 模块名
     */
...
//        strategy.setInclude(new String[]{"user"});
        strategy.setInclude(new String[]{"pricing_info","marketer_info","marketer_account","distribution_topic_info","link_info","distribution_goods","`recharge_template","ad_callback_rule"});
